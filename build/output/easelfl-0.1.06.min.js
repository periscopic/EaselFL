...
1&&b._tick()};b._handleTimeout=function(){b.timeoutID=null;b._setupTick();b._tick()};b._setupTick=function(){if(!(b._rafActive||null!=b.timeoutID)){if(b.useRAF){var a=h.requestAnimationFrame||h.webkitRequestAnimationFrame||h.mozRequestAnimationFrame||h.oRequestAnimationFrame||h.msRequestAnimationFrame;if(a){a(b._handleAF,b.animationTarget);b._rafActive=!0;return}}b.timeoutID=setTimeout(b._handleTimeout,b._interval)}};b._tick=function(){b._ticks++;var a=b._getTime(),i=a-b._lastTime,g=b._paused;g&&
(b._pausedTickers++,b._pausedTime+=i);b._lastTime=a;for(var c=b._pauseable,d=b._listeners.slice(),e=d?d.length:0,f=0;f<e;f++){var j=d[f];null==j||g&&c[f]||(j.tick?j.tick(i,g):j instanceof Function&&j(i,g))}for(b._tickTimes.unshift(b._getTime()-a);100<b._tickTimes.length;)b._tickTimes.pop();for(b._times.unshift(a);100<b._times.length;)b._times.pop()};b._getTime=function(){return(new Date).getTime()};h.Ticker=b})(window);(function(h){var b=function(i,a,b,d,e){this.initialize(i,a,b,d,e)},a=b.prototype;a.stageX=0;a.stageY=0;a.type=null;a.nativeEvent=null;a.onMouseMove=null;a.onMouseUp=null;a.target=null;a.initialize=function(i,a,b,d,e){this.type=i;this.stageX=a;this.stageY=b;this.target=d;this.nativeEvent=e};a.clone=function(){return new b(this.type,this.stageX,this.stageY,this.target,this.nativeEvent)};a.toString=function(){return"[MouseEvent (type="+this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};h.MouseEvent=
b})(window);(function(h){var b=function(i,a,b,d,e,f){this.initialize(i,a,b,d,e,f)},a=b.prototype;b.identity=null;b.DEG_TO_RAD=Math.PI/180;a.a=1;a.b=0;a.c=0;a.d=1;a.tx=0;a.ty=0;a.alpha=1;a.shadow=null;a.compositeOperation=null;a.initialize=function(a,g,b,d,e,f){null!=a&&(this.a=a);this.b=g||0;this.c=b||0;null!=d&&(this.d=d);this.tx=e||0;this.ty=f||0};a.prepend=function(a,g,b,d,e,f){var j=this.tx;if(1!=a||0!=g||0!=b||1!=d){var p=this.a,h=this.c;this.a=p*a+this.b*b;this.b=p*g+this.b*d;this.c=h*a+this.d*b;this.d=
h*g+this.d*d}this.tx=j*a+this.ty*b+e;this.ty=j*g+this.ty*d+f};a.append=function(a,g,b,d,e,f){var j=this.a,p=this.b,h=this.c,k=this.d;this.a=a*j+g*h;this.b=a*p+g*k;this.c=b*j+d*h;this.d=b*p+d*k;this.tx=e*j+f*h+this.tx;this.ty=e*p+f*k+this.ty};a.prependMatrix=function(a){this.prepend(a.a,a.b,a.c,a.d,a.tx,a.ty);this.prependProperties(a.alpha,a.shadow,a.compositeOperation)};a.appendMatrix=function(a){this.append(a.a,a.b,a.c,a.d,a.tx,a.ty);this.appendProperties(a.alpha,a.shadow,a.compositeOperation)};
a.prependTransform=function(a,g,c,d,e,f,j,h,l){if(e%360)var k=e*b.DEG_TO_RAD,e=Math.cos(k),k=Math.sin(k);else e=1,k=0;if(h||l)this.tx-=h,this.ty-=l;f||j?(f*=b.DEG_TO_RAD,j*=b.DEG_TO_RAD,this.prepend(e*c,k*c,-k*d,e*d,0,0),this.prepend(Math.cos(j),Math.sin(j),-Math.sin(f),Math.cos(f),a,g)):this.prepend(e*c,k*c,-k*d,e*d,a,g)};a.appendTransform=function(a,g,c,d,e,f,j,h,l){if(e%360)var k=e*b.DEG_TO_RAD,e=Math.cos(k),k=Math.sin(k);else e=1,k=0;f||j?(f*=b.DEG_TO_RAD,j*=b.DEG_TO_RAD,this.append(Math.cos(j),
Math.sin(j),-Math.sin(f),Math.cos(f),a,g),this.append(e*c,k*c,-k*d,e*d,0,0)):this.append(e*c,k*c,-k*d,e*d,a,g);if(h||l)this.tx-=h*this.a+l*this.c,this.ty-=h*this.b+l*this.d};a.rotate=function(a){var g=Math.cos(a),a=Math.sin(a),b=this.a,d=this.c,e=this.tx;this.a=b*g-this.b*a;this.b=b*a+this.b*g;this.c=d*g-this.d*a;this.d=d*a+this.d*g;this.tx=e*g-this.ty*a;this.ty=e*a+this.ty*g};a.skew=function(a,g){a*=b.DEG_TO_RAD;g*=b.DEG_TO_RAD;this.append(Math.cos(g),Math.sin(g),-Math.sin(a),Math.cos(a),0,0)};a.scale=
function(a,g){this.a*=a;this.d*=g;this.tx*=a;this.ty*=g};a.translate=function(a,g){this.tx+=a;this.ty+=g};a.identity=function(){this.alpha=this.a=this.d=1;this.b=this.c=this.tx=this.ty=0;this.shadow=this.compositeOperation=null};a.invert=function(){var a=this.a,g=this.b,b=this.c,d=this.d,e=this.tx,f=a*d-g*b;this.a=d/f;this.b=-g/f;this.c=-b/f;this.d=a/f;this.tx=(b*this.ty-d*e)/f;this.ty=-(a*this.ty-g*e)/f};a.isIdentity=function(){return 0==this.tx&&0==this.ty&&1==this.a&&0==this.b&&0==this.c&&1==this.d};
a.decompose=function(a){null==a&&(a={});a.x=this.tx;a.y=this.ty;a.scaleX=Math.sqrt(this.a*this.a+this.b*this.b);a.scaleY=Math.sqrt(this.c*this.c+this.d*this.d);var g=Math.atan2(-this.c,this.d),c=Math.atan2(this.b,this.a);g==c?(a.rotation=c/b.DEG_TO_RAD,0>this.a&&0<=this.d&&(a.rotation+=0>=a.rotation?180:-180),a.skewX=a.skewY=0):(a.skewX=g/b.DEG_TO_RAD,a.skewY=c/b.DEG_TO_RAD);return a};a.reinitialize=function(a,g,b,d,e,f,j,h,l){this.initialize(a,g,b,d,e,f);this.alpha=j||1;this.shadow=h;this.compositeOperation=
l;return this};a.appendProperties=function(a,g,b){this.alpha*=a;this.shadow=g||this.shadow;this.compositeOperation=b||this.compositeOperation};a.prependProperties=function(a,g,b){this.alpha*=a;this.shadow=this.shadow||g;this.compositeOperation=this.compositeOperation||b};a.clone=function(){var a=new b(this.a,this.b,this.c,this.d,this.tx,this.ty);a.shadow=this.shadow;a.alpha=this.alpha;a.compositeOperation=this.compositeOperation;return a};a.toString=function(){return"[Matrix2D (a="+this.a+" b="+this.b+
" c="+this.c+" d="+this.d+" tx="+this.tx+" ty="+this.ty+")]"};b.identity=new b(1,0,0,1,0,0);h.Matrix2D=b})(window);(function(h){var b=function(a,g){this.initialize(a,g)},a=b.prototype;a.x=0;a.y=0;a.initialize=function(a,g){this.x=null==a?0:a;this.y=null==g?0:g};a.clone=function(){return new b(this.x,this.y)};a.toString=function(){return"[Point (x="+this.x+" y="+this.y+")]"};h.Point=b})(window);(function(h){var b=function(a,g,b,d){this.initialize(a,g,b,d)},a=b.prototype;a._flX=0;a._flY=0;a._flWidth=0;a._flHeight=0;a._flCtx=a.id=null;a._flSync=function(a){this._flCtx||(this.id=UID.get(),this._flCtx=a,a._flCreate.push(["rct",this]));if(this._flX!==this.x||this._flY!==this.y||this._flWidth!==this.width||this._flHeight!==this.height)this._flX=this.x,this._flY=this.y,this._flWidth=this.width,this._flHeight=this.height,this._flCtx._flChange.push([this.id,"dim",[this.x,this.y,this.width,this.height]])};
a.x=0;a.y=0;a.width=0;a.height=0;a.initialize=function(a,g,b,d){this.x=null==a?0:a;this.y=null==g?0:g;this.width=null==b?0:b;this.height=null==d?0:d};a.clone=function(){return new b(this.x,this.y,this.width,this.height)};a.toString=function(){return"[Rectangle (x="+this.x+" y="+this.y+" width="+this.width+" height="+this.height+")]"};h.Rectangle=b})(window);(function(h){function b(a){this.initialize(a)}function a(i){var c;i.width=parseFloat(i.getAttribute("width")||a.FL_WIDTH);i.height=parseFloat(i.getAttribute("height")||a.FL_HEIGHT);c=i.getAttribute("transparent");i.transparent=!c||!0===c||"true"===c.toLowerCase();this._ctx=new b(i);this._ctx._flCanvas=this;this.width=i.width;this.height=i.height}var i=b.prototype;i._flCommandQueues=null;i._flInstance=null;i._flInstanceID=null;i._flChange=null;i._flCreate=null;i._flItemIndex=null;i._flCurPressEvent=
null;i._flCanvas=null;i._flFlush=function(){if(this.flReady){var a=this._flInstance;if(this._flCreate.length){for(var i=this._flCreate,b,e=this._flItemIndex,f=0,j=i.length;f<j;++f)b=i[f][1],i[f][1]=b.id,e[b.id]=b;a.sendCreate(this._flCreate);this._flCreate=[]}this._flChange.length&&(a.sendChange(this._flChange),this._flChange=[])}};i.flInvoke=function(a,i,b){return this._flInstance?this._flInstance.sendInvoke([a,i,b]):null};i._flOnReady=function(){this._flInstance=b._flGetInstance(this._flInstanceID);
this.flReady=!0;this._flFlush();this._flCanvas._stage&&this._flCanvas._stage.flOnReady&&(this._flCanvas._stage.flReady=!0,this._flCanvas._stage.flOnReady(this._flCanvas._stage))};i.initialize=function(i){function c(a){var i,b;if("onClick"===a.type||"onMouseOver"===a.type||"onMouseOut"===a.type||"onPress"===a.type||"onMouseMove"===a.type||"onMouseUp"===a.type)if("onMouseMove"===a.type||"onMouseUp"===a.type?(b=e._flCurPressEvent,i=b.target,"onMouseUp"===a.type&&(e._flCurPressEvent=null)):b=i=e._flItemIndex[a.id],
b&&b[a.type])i=new MouseEvent(a.type,a.stageX,a.stageY,i,null),b[a.type](i),"onPress"===a.type&&(e._flCurPressEvent=i)}var d,e=this,f=i.getAttribute("id"),j=i.getAttribute("fl_swf_url")||a.FL_URL;this._flCreate=[];this._flChange=[];this._flItemIndex={};d="EaselFl_"+b._flCount++;this._flInstanceID=f||d;f!==this._flInstanceID&&i.setAttribute("id",d);a._flHooks[d]=function(){a._flHooks[d]=c;e._flOnReady()};b._flLoadInstance(d,i.width,i.height,i.transparent,this._flInstanceID,j)};b._flCount=0;b._flLoadInstance=
function(a,i,b,e,f,j){swfobject.embedSWF(j,f,i.toString(),b.toString(),"9.0.0",!1,{id:a},{scale:"noscale",salign:"TL",wmode:e?"transparent":"opaque"})};b._flGetInstance=function(a){return/Explorer/.test(navigator.appName)?h[a]:document[a]};i=a.prototype;i._ctx=null;i._stage=null;i.width=0;i.height=0;i.transparent=!0;i.isFl=!0;i.getContext=function(a){return"2d"===a?this._ctx:null};a.FL_URL="EaselFl.swf";a.FL_WIDTH="400";a.FL_HEIGHT="400";a._flHooks={};h.CanvasFl=a})(window);(function(h){var b=function(a){this.id=UID.get();this._img=a},a=b.prototype;a.id=null;a._img=null;a._flCtx=null;a._flSrc=null;a.sync=function(a){this._flCtx||(this._flCtx=a,a._flCreate.push(["img",this]));this._flSrc!==this._img.src&&(this._flSrc=this._img.src,a._flChange.push([this.id,"src",this._flSrc]))};b.watch=function(a){return!a.__fl?(a.__fl=new b(a),!0):!1};h.ImageFl=b})(window);(function(h){var b=function(){this.initialize()},a=b.prototype;a._flChange=null;a._flChildImages=null;b.getRGB=function(a,b,c,d){null!=a&&null==c&&(d=b,c=a&255,b=a>>8&255,a=a>>16&255);return null==d?"rgb("+a+","+b+","+c+")":"rgba("+a+","+b+","+c+","+d+")"};b.getHSL=function(a,b,c,d){return null==d?"hsl("+a%360+","+b+"%,"+c+"%)":"hsla("+a%360+","+b+"%,"+c+"%,"+d+")"};b.BASE_64={A:0,B:1,C:2,D:3,E:4,F:5,G:6,H:7,I:8,J:9,K:10,L:11,M:12,N:13,O:14,P:15,Q:16,R:17,S:18,T:19,U:20,V:21,W:22,X:23,Y:24,Z:25,a:26,
...
b,c,d){this._flChange.push([this.id,"de",[a,b,c,d]]);return this};a.drawPolyStar=function(a,b,c,d,e,f){this._flChange.push([this.id,"dp",[a,b,c,d,e,f]]);return this};a.decodePath=function(a){for(var g=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],c=[2,2,4,6],d=0,e=a.length,f=[],j=0,h=0,l=b.BASE_64;d<e;){var k=l[a.charAt(d)],n=k>>3,q=g[n];if(!q||k&3)throw"bad path data";var r=c[n];n||(j=h=0);f.length=0;d++;k=(k>>2&1)+2;for(n=0;n<r;n++){var m=l[a.charAt(d)],s=m>>5?-1:1,m=(m&31)<<
...
!1,this.filters&&0<this.filters.length)){for(var g=[],c=0,d=this.filters.length;c<d;c++){var e=this.filters[c];e._flSyncProps(a);g[c]=e.id}this._flChange.push([this.id,"flts",g])}this.mask!==this._flMask&&(this._flMask=this.mask,this._flChange.push([this.id,"msk",this.mask?this.mask.id:null]));if(this.x!==this._flX||this.y!==this._flY||this.scaleX!==this._flScaleX||this.scaleY!==this._flScaleY||this.rotation!==this._flRotation||this.skewX!==this._flSkewX||this.skewY!==this._flSkewY||this.regX!==this._flRegX||
...
function(a,b){var c=this.localToGlobal(a,b);return this._getObjectsUnderPoint(c.x,c.y)};a.clone=function(a){var g=new b;this.cloneProps(g);if(a)for(var c=g.children=[],d=0,e=this.children.length;d<e;d++){var f=this.children[d].clone(a);f.parent=g;c.push(f)}return g};a.toString=function(){return"[Container (name="+this.name+")]"};a._tick=function(a){for(var b=this.children.length-1;0<=b;b--){var c=this.children[b];c._tick&&c._tick(a)}if(this.onTick)this.onTick(a)};a._getObjectsUnderPoint=function(a,
g,c,d){var e=DisplayObject._hitTestContext,f=DisplayObject._hitTestCanvas,j=this._matrix,h=d&1&&(this.onPress||this.onClick||this.onDoubleClick)||d&2&&(this.onMouseOver||this.onMouseOut);if(this.cacheCanvas)if(this.getConcatenatedMatrix(j),e.setTransform(j.a,j.b,j.c,j.d,j.tx-a,j.ty-g),e.globalAlpha=j.alpha,this.draw(e),this._testHit(e)){if(f.width=0,f.width=1,h)return this}else return null;for(var l=this.children.length-1;0<=l;l--){var k=this.children[l];if(k.isVisible()&&k.mouseEnabled)if(k instanceof
b)if(h){if(k=k._getObjectsUnderPoint(a,g))return this}else{if(k=k._getObjectsUnderPoint(a,g,c,d),!c&&k)return k}else if(!d||h||d&1&&(k.onPress||k.onClick||k.onDoubleClick)||d&2&&(k.onMouseOver||k.onMouseOut))if(k.getConcatenatedMatrix(j),e.setTransform(j.a,j.b,j.c,j.d,j.tx-a,j.ty-g),e.globalAlpha=j.alpha,k.draw(e),this._testHit(e)){f.width=0;f.width=1;if(h)return this;if(c)c.push(k);else return k}}return null};a._flCtx=null;a.addChildAt=function(a,b){var c=arguments.length;if(2<c){for(var b=arguments[d-
...
a.toString=function(){return"[Stage (name="+this.name+")]"};a._enableMouseEvents=function(){var a=this,b=h.addEventListener||document.addEventListener?"addEventListener":"attachEvent";(h[b]?h:document)[b]("mousemove",function(b){a._handleMouseMove(b)},!1)};a._handleMouseMove=function(a){this.canvas?(a||(a=h.event),this._updateMousePosition(a.pageX,a.pageY)):this.mouseX=this.mouseY=null};a._updateMousePosition=function(a,b){var c=this.canvas._ctx._flInstance;if(c){do a-=c.offsetLeft,b-=c.offsetTop;
while(c=c.offsetParent);if(this.mouseInBounds=0<=a&&0<=b&&a<this.canvas.width&&b<this.canvas.height)this.mouseX=a,this.mouseY=b}};a._handleMouseUp=function(){};a._handleMouseDown=function(){};a._testMouseOver=function(){};a._handleDoubleClick=function(){};b.FL_THROW_UNIMPLEMENTED=!0;b.FL_LOG_PART_IMPLEMENTED=!0;h.Stage=b})(window);(function(h){var b=function(a){this.initialize(a)},a=b.prototype=new DisplayObject;a.image=null;a.snapToPixel=!0;a.sourceRect=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(a){this.DisplayObject_initialize();"string"==typeof a?(this.image=new Image,this.image.src=a):this.image=a};a.isVisible=function(){return this.visible&&0<this.alpha&&0!=this.scaleX&&0!=this.scaleY&&this.image&&(this.image.complete||this.image.getContext||2<=this.image.readyState)};a.DisplayObject_draw=a.draw;
