...
this.type+" stageX="+this.stageX+" stageY="+this.stageY+")]"};e.MouseEvent=b})(createjs||(createjs={}));(function(e){var b=function(c,a,d,f,b,g){this.initialize(c,a,d,f,b,g)},a=b.prototype;b.identity=null;b.DEG_TO_RAD=Math.PI/180;a.a=1;a.b=0;a.c=0;a.d=1;a.tx=0;a.ty=0;a.alpha=1;a.shadow=null;a.compositeOperation=null;a.initialize=function(c,a,d,f,b,g){null!=c&&(this.a=c);this.b=a||0;this.c=d||0;null!=f&&(this.d=f);this.tx=b||0;this.ty=g||0;return this};a.prepend=function(c,a,d,f,b,g){var e=this.tx;if(1!=c||0!=a||0!=d||1!=f){var i=this.a,l=this.c;this.a=i*c+this.b*d;this.b=i*a+this.b*f;this.c=l*c+this.d*
d;this.d=l*a+this.d*f}this.tx=e*c+this.ty*d+b;this.ty=e*a+this.ty*f+g;return this};a.append=function(c,a,d,b,h,g){var e=this.a,i=this.b,l=this.c,j=this.d;this.a=c*e+a*l;this.b=c*i+a*j;this.c=d*e+b*l;this.d=d*i+b*j;this.tx=h*e+g*l+this.tx;this.ty=h*i+g*j+this.ty;return this};a.prependMatrix=function(c){this.prepend(c.a,c.b,c.c,c.d,c.tx,c.ty);this.prependProperties(c.alpha,c.shadow,c.compositeOperation);return this};a.appendMatrix=function(c){this.append(c.a,c.b,c.c,c.d,c.tx,c.ty);this.appendProperties(c.alpha,
c.shadow,c.compositeOperation);return this};a.prependTransform=function(c,a,d,f,h,g,e,i,l){if(h%360)var j=h*b.DEG_TO_RAD,h=Math.cos(j),j=Math.sin(j);else h=1,j=0;if(i||l)this.tx-=i,this.ty-=l;g||e?(g*=b.DEG_TO_RAD,e*=b.DEG_TO_RAD,this.prepend(h*d,j*d,-j*f,h*f,0,0),this.prepend(Math.cos(e),Math.sin(e),-Math.sin(g),Math.cos(g),c,a)):this.prepend(h*d,j*d,-j*f,h*f,c,a);return this};a.appendTransform=function(c,a,d,f,h,g,e,i,l){if(h%360)var j=h*b.DEG_TO_RAD,h=Math.cos(j),j=Math.sin(j);else h=1,j=0;g||
e?(g*=b.DEG_TO_RAD,e*=b.DEG_TO_RAD,this.append(Math.cos(e),Math.sin(e),-Math.sin(g),Math.cos(g),c,a),this.append(h*d,j*d,-j*f,h*f,0,0)):this.append(h*d,j*d,-j*f,h*f,c,a);if(i||l)this.tx-=i*this.a+l*this.c,this.ty-=i*this.b+l*this.d;return this};a.rotate=function(c){var a=Math.cos(c),c=Math.sin(c),d=this.a,b=this.c,h=this.tx;this.a=d*a-this.b*c;this.b=d*c+this.b*a;this.c=b*a-this.d*c;this.d=b*c+this.d*a;this.tx=h*a-this.ty*c;this.ty=h*c+this.ty*a;return this};a.skew=function(c,a){c*=b.DEG_TO_RAD;a*=
...
[];this._data={};for(var k in b){c={name:k};g=b[k];if(isNaN(g))if(g instanceof Array){c.frequency=g[3];c.next=g[2];f=c.frames=[];for(a=g[0];a<=g[1];a++)f.push(a)}else c.frequency=g.frequency,c.next=g.next,a=g.frames,f=c.frames=!isNaN(a)?[a]:a.slice(0);else f=c.frames=[g];c.next=2>f.length||!1==c.next?null:null==c.next||!0==c.next?k:c.next;c.frequency||(c.frequency=1);this._animations.push(k);this._data[k]=c}}}};a.getNumFrames=function(c){if(null==c)return this._frames?this._frames.length:this._numFrames;
...
"f",[c]]);return this};a.beginLinearGradientFill=function(c,a,b,f,h,g){this._flChange.push([this.id,"lf",[c,a,b,f,h,g]]);return this};a.beginRadialGradientFill=function(c,a,b,f,h,g,e,i){this._flChange.push([this.id,"rf",[c,a,b,f,h,g,e,i]]);return this};a.beginBitmapFill=function(c,a){e.Stage.FL_LOG_PART_IMPLEMENTED&&(a&&"repeat-x"===a||"repeat-y"===a)&&console.log("EaselFl:Graphics.beginBitmapFill currently does not implement repeat-x or repeat-y");e.ImageFl.watch(c);this._flChildImages.push(c.__fl);
...
"ls",[c,a,b,f,h,g]]);return this};a.beginRadialGradientStroke=function(c,a,b,f,h,g,e,i){this._flChange.push([this.id,"rs",[c,a,b,f,h,g,e,i]]);return this};a.beginBitmapStroke=function(c,a){e.ImageFl.watch(c);this._flChildImages.push(c.__fl);this._flChange.push([this.id,"bs",[c.__fl.id,a]]);return this};a.endStroke=function(){this._flChange.push([this.id,"es"]);return this};a.curveTo=a.quadraticCurveTo;a.drawRect=a.rect;a.drawRoundRect=function(c,a,b,f,h){this._flChange.push([this.id,"rr",[c,a,b,f,
h]]);return this};a.drawRoundRectComplex=function(c,a,b,f,h,g,e,i){this._flChange.push([this.id,"rc",[c,a,b,f,h,g,e,i]]);return this};a.drawCircle=function(c,a,b){this._flChange.push([this.id,"dc",[c,a,b]]);return this};a.drawEllipse=function(c,a,b,f){this._flChange.push([this.id,"de",[c,a,b,f]]);return this};a.drawPolyStar=function(a,b,d,f,e,g){this._flChange.push([this.id,"dp",[a,b,d,f,e,g]]);return this};a.decodePath=function(a){for(var m=[this.moveTo,this.lineTo,this.quadraticCurveTo,this.bezierCurveTo],
d=[2,2,4,6],f=0,e=a.length,g=[],k=0,i=0,l=b.BASE_64;f<e;){var j=l[a.charAt(f)],n=j>>3,q=m[n];if(!q||j&3)throw"bad path data";var r=d[n];n||(k=i=0);g.length=0;f++;j=(j>>2&1)+2;for(n=0;n<r;n++){var p=l[a.charAt(f)],s=p>>5?-1:1,p=(p&31)<<6|l[a.charAt(f+1)];3==j&&(p=p<<6|l[a.charAt(f+2)]);p=s*p/10;n%2?k=p+=k:i=p+=i;g[n]=p;f+=j}q.apply(this,g)}return this};a.clone=function(){if(e.Stage.FL_THROW_UNIMPLEMENTED)throw"EaselFl:Graphics.clone currently not implemented";return o};a.toString=function(){return"[Graphics]"};
...
if(this._flCached||!this.isVisible())return!0;this._flCached=this._flCache;for(var b=this.children.length,f=this.children.slice(0),e=0;e<b;e++){var g=f[e],k=g._matrix.reinitialize(d.a,d.b,d.c,d.d,d.tx,d.ty,d.alpha,d.shadow,d.compositeOperation);k.appendTransform(g.x,g.y,g.scaleX,g.scaleY,g.rotation,g.skewX,g.skewY,g.regX,g.regY);k.appendProperties(g.alpha,g.shadow,g.compositeOperation);g.draw(a,!1,k)}return!0};a.addChild=function(a){if(null==a)return a;var b=arguments.length;if(1<b){for(var d=0;d<
...
f=d[a],e=d[b];f&&e&&(d[a]=e,d[b]=f)};a.swapChildren=function(a,b){for(var d=this.children,f,e,g=0,k=d.length;g<k&&!(d[g]==a&&(f=g),d[g]==b&&(e=g),null!=f&&null!=e);g++);g!=k&&(d[f]=b,d[e]=a)};a.setChildIndex=function(){if(e.Stage.FL_THROW_UNIMPLEMENTED)throw"EaselFl:Container.setChildIndex not yet implemented";};a.contains=function(a){for(;a;){if(a==this)return!0;a=a.parent}return!1};a.getObjectsUnderPoint=function(a,b){var d=[],f=this.localToGlobal(a,b);this._getObjectsUnderPoint(f.x,f.y,d);return d};
...
(document[e]?document:window)[e](b.__MS_BINDING?"onmousemove":"mousemove",function(b){a._handleMouseMove(b)},!1)};a._handleMouseMove=function(a){if(this.canvas){a||(a=window.event);var m=this.mouseInBounds;b.__MS_BINDING?this._updatePointerPosition(-1,a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.clientY+document.body.scrollTop+document.documentElement.scrollTop):this._updatePointerPosition(-1,a.pageX,a.pageY);if(m||this.mouseInBounds){a=new e.MouseEvent("onMouseMove",this.mouseX,
...
d.localToLocal=function(){};d.clone=function(){var a=new m;this.cloneProps(a);return a};d.toString=function(){return"[DOMElement (name="+this.name+")]"};d._tick=function(a){if(null!=this.htmlElement&&(this._flCumMtx&&this._flSyncVisibility()&&this._flSyncTransform(),this.onTick))this.onTick(a)};d._flSimpleTransform=!0;d._flWidth=0;d._flHeight=0;d._flLastMtx=null;d._flBx=0;d._flBy=0;d._flVisible=!0;d._flAlpha=1;d._flCumMtx=null;d._flMsMtx="";d._flMsAlpha="";d._flMsCum=" ";d._flParentNode=null;d._flCtx=
...
"flt",[this.blurX,this.blurY,2.5*this.quality]])};e.BoxBlurFilter=b})(createjs||(createjs={}));(function(e){var b=function(a,b,d,e,h,g,k,i){this.initialize(a,b,d,e,h,g,k,i)},a=b.prototype=new e.Filter;a.redMultiplier=1;a.greenMultiplier=1;a.blueMultiplier=1;a.alphaMultiplier=1;a.redOffset=0;a.greenOffset=0;a.blueOffset=0;a.alphaOffset=0;a.initialize=function(a,b,d,f,h,g,k,i){this.redMultiplier=null!=a?a:1;this.greenMultiplier=null!=b?b:1;this.blueMultiplier=null!=d?d:1;this.alphaMultiplier=null!=f?f:1;this.redOffset=h||0;this.greenOffset=g||0;this.blueOffset=k||0;this.alphaOffset=i||0;this.id=
